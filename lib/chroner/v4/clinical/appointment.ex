defmodule Chroner.V4.Clinical.Appointment do
  ...
  @type t :: %__MODULE__{
          ...
          duration: integer(),
          exam_room: integer(),
          extended_updated_at: String.t(),
          first_billed_date: String.t(),
          icd10_codes: String.t(),
          icd9_codes: String.t(),
          id: integer(),
          is_virtual_base: boolean(),
          is_walk_in: boolean(),
          last_billed_date: String.t(),
          notes: String.t(),
          office: integer(),
          patient: integer() | nil,
  ...
  embedded_schema do
    ...
    field :cloned_from, :integer, null: true
    field :color, :string
    ...
    field :extended_updated_at, :string
    field :first_billed_date, :string
    field :icd10_codes, :string
    field :icd9_codes, :string
    field :id, :integer
    field :is_virtual_base, :boolean
    field :is_walk_in, :boolean
    field :last_billed_date, :string
    field :notes, :string
    field :office, :integer
    field :patient, :integer, null: true
    ...
    field :status, :string
    embeds_one :status_transitions, StatusTransitions
