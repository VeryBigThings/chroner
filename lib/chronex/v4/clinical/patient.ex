defmodule Chronex.V4.Clinical.Patient do
  ...
  alias Chronex.V4.Administrative.Doctor
  alias Chronex.V4.Clinical.Customs.CustomDemographic
  alias Chronex.V4.Clinical.{PatientFlag, PatientFlagAttached}

  alias Chronex.V4.Clinical.Patient.{
